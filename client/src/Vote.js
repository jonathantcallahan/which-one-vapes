...
class Vote extends Component {
    ...
    componentWillReceiveProps(newProps){
        newProps !== this.props && this.setState({vote:false})
    }
    ...
    render(){ 
        return(
            <div className='column vote-column'>
                <div className='column-header'>VOTE</div>
                {this.props.state && (
                    <div className='voting-container'>
                        <div className={'voting-image-container image-one ' + this.state.imageOne} 
                        ...
                        <div 
                            className={'voting-image-container image-two ' + this.state.imageTwo} 
                            voting-image='2' 
